...
INSERT INTO ROLES(ROWNUMBER, ID, BONUS_FROM_SALES, SESSION_PLAN, TEAMBONUS_COEF, NAME, PERMISSIONS) VALUES(1, '0', 0.0, 0.0, 0.0, 'Administrator role', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml});
INSERT INTO ROLES(ROWNUMBER, ID, BONUS_FROM_SALES, SESSION_PLAN, TEAMBONUS_COEF, NAME, PERMISSIONS) VALUES(2, '1', 0.0, 0.0, 0.0, 'Manager role', $FILE{/com/openbravo/pos/templates/Role.Manager.xml});
INSERT INTO ROLES(ROWNUMBER, ID, BONUS_FROM_SALES, SESSION_PLAN, TEAMBONUS_COEF, NAME, PERMISSIONS) VALUES(3, '2', 0.01, 25000.0, 1.0, 'Employee role', $FILE{/com/openbravo/pos/templates/Role.Employee.xml});
INSERT INTO ROLES(ROWNUMBER, ID, BONUS_FROM_SALES, SESSION_PLAN, TEAMBONUS_COEF, NAME, PERMISSIONS) VALUES(4, '3', 0.01, 25000.0, 1.0, 'Guest role', $FILE{/com/openbravo/pos/templates/Role.Guest.xml});
INSERT INTO ROLES(ROWNUMBER, ID, BONUS_FROM_SALES, SESSION_PLAN, TEAMBONUS_COEF, NAME, PERMISSIONS) VALUES(5, 'TEAMBONUSCONFIG', 0.01, 150000.0, 1.0, 'Teambonus configuration role', $FILE{/com/openbravo/pos/templates/Role.Teambonus.xml});
...
INSERT INTO RESOURCES(ID, NAME, RESTYPE, CONTENT) VALUES('9', 'Window.Logo', 1, $FILE{/com/openbravo/pos/templates/Window.Logo.Forte.png});
