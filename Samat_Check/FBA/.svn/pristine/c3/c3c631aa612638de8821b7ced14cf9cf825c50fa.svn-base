...
// bonus config import
import net.ddns.evcalyptus.bonus.DataLogicIndivBonus;
...
//    private ScriptObject scriptobjinst;
    ...
    private boolean autoAttrEditOnOff = true;
    ...
    private DataLogicIndivBonus dlIndivBonus;
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        dlIndivBonus = (DataLogicIndivBonus) m_App.getBean("net.ddns.evcalyptus.bonus.DataLogicIndivBonus");
    ...
    protected void addTicketLine(TicketLineInfo oLine) {   
        ...
        if (autoAttrEditOnOff == true) { //some stupid hack just to enable testing.  need to replace by introducing PropertiesConfig class
                    ...
                    if (paymentdialog.showDialog(ticket.getTotal(), ticket.getCustomer())) {
                        ...
                        if (executeEvent(ticket, ticketext, "ticket.save") == null) {
                            ...
                            try {
                                ...
                                String role = dlIndivBonus.getRole(ticket.getUser().getId().toString());
                                dlIndivBonus.bonusAddTicket(ticket, dl_BonusConfig.mapIndivBonus.get(role));
                            } catch (BasicException eData) {
...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        jAutoEditAttrOnOff = new javax.swing.JRadioButton();
        ...
        jEditAttributes.setMaximumSize(new java.awt.Dimension(50, 40));
        jEditAttributes.setMinimumSize(new java.awt.Dimension(50, 40));
        jEditAttributes.setOpaque(true);
        jEditAttributes.setPreferredSize(new java.awt.Dimension(50, 40));
        ...
        jAutoEditAttrOnOff.setSelected(true);
        jAutoEditAttrOnOff.setText("Auto");
        jAutoEditAttrOnOff.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jAutoEditAttrOnOffStateChanged(evt);
            }
        });
        jPanel2.add(jAutoEditAttrOnOff);
    ...
    private void jAutoEditAttrOnOffStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jAutoEditAttrOnOffStateChanged
        // TODO add your handling code here:
        if (autoAttrEditOnOff == true) {
            autoAttrEditOnOff = false;
        }
        else {
            autoAttrEditOnOff = true;
    }//GEN-LAST:event_jAutoEditAttrOnOffStateChanged
}
    ...
    private javax.swing.JRadioButton jAutoEditAttrOnOff;
