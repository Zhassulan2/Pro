...
public class JTicketsBagTicket extends JTicketsBag {
    ...
    private DataLogicIndivBonus dl_IndivBonus = null;
    ...
    public JTicketsBagTicket(AppView app, JPanelTicketEdits panelticket) {
        ...
        dl_IndivBonus = (DataLogicIndivBonus) m_App.getBean("net.ddns.evcalyptus.bonus.DataLogicIndivBonus");
    ...
    public void deleteTicket() {
        ...
        if (m_ticketCopy != null) {           
            ...
            try {               
                dl_IndivBonus.bonusDeleteTicket(m_ticketCopy);
