...
public class StockDiaryEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    //creating a button for autocalling Attributes Editor
    //private boolean autoEditAttrOnOff = true;
...
//    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(10, 120, 150, 17);

        jattributes.setEditable(false);
        jPanel1.add(jattributes);
        jattributes.setBounds(160, 210, 250, 27);
        ...
        jEditAttributes.setBounds(420, 210, 40, 28);
        ...
        m_jEnter.setBounds(420, 150, 40, 28);
        ...
        jproduct.setBounds(160, 180, 250, 27);
        ...
        jEditProduct.setBounds(420, 180, 40, 28);

        jLabel9.setText(AppLocal.getIntString("label.attributes")); // NOI18N
        jPanel1.add(jLabel9);
        jLabel9.setBounds(10, 210, 150, 17);
