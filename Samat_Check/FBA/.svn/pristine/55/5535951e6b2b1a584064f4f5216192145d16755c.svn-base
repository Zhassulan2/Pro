...
public class DataLogicAdmin extends BeanFactoryDataSingle {
    ...
    public void init(Session s){
        ...
        m_troles = new TableDefinition(s,
            "ROLES"
            , new String[] {"ID", "ROWNUMBER", "BONUS_FROM_SALES", "SESSION_PLAN", "TEAMBONUS_COEF", "NAME", "PERMISSIONS"}
            , new String[] {"ID", "ROWNUMBER", "BONUS_FROM_SALES", "SESSION_PLAN", "TEAMBONUS_COEF", AppLocal.getIntString("Label.Name"), "PERMISSIONS"}
            , new Datas[] {Datas.STRING, Datas.INT, Datas.DOUBLE, Datas.DOUBLE, Datas.DOUBLE, Datas.STRING, Datas.BYTES}
            , new Formats[] {Formats.STRING, Formats.INT, Formats.DOUBLE, Formats.DOUBLE, Formats.DOUBLE, Formats.STRING, Formats.NULL}
            , new int[] {0}
        );  
