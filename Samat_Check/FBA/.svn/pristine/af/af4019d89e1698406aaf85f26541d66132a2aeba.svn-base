...
public class JPanelSettingsDefault extends JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void activate() throws BasicException {
        ...
        jDefProdMargin.setText(hostProp.getProperty("defaultproductmargin"));
    ...
    private void saveProperties() {
        ...
        hostProp.setProperty("defaultproductmargin",jDefProdMargin.getText());
    ...
    private void initComponents() {
        ...
        jDefProdMargin = new javax.swing.JTextField();
        ...
        jLabel13.setText(AppLocal.getIntString("Label.DefProdMargin"));

        jDefProdMargin.setText("jTextField1");
            ...
            .addGroup(jPanelSetLayout.createSequentialGroup()
                ...
                .addGroup(jPanelSetLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelSetLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jDefProdMargin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(3, 3, 3)
    ...
    private javax.swing.JTextField jDefProdMargin;
