...
public class ProductsEditor extends JPanel implements EditorRecord {
    ...
    private String s_DefProdMargin;
    ...
    Logger l = Logger.getLogger(ProductsEditor.class.getName());
    ...
    public void activate() throws BasicException {
        ...
        s_DefProdMargin = m_App.getDefaultProductMargin();
...
//        m_jRef.setText(null);
        if (s_GenRef.equals("true")) {
            ...
            for (int i = sReferense.length(); i < 6; i++) {
  ...
  //          m_jRef.setBackground(COLOR_MANDATORY_FIELD);
        ...
        if (s_DefProdMargin != null) {
            Double marginFromString = Double.parseDouble(s_DefProdMargin);
            Double marginCalc = new Double (marginFromString/100);
            m_jmargin.setText(Formats.PERCENT.formatValue(marginCalc));
            //l.info("Double marginFromString = " + marginFromString);
            //l.info("Double marginCalc = " + marginCalc);
            //l.info("m_jmargin.getText() = " + m_jmargin.getText());
        }
    ...
    private void calculateMargin() {
        ...
        if (!reportlock) {
            ...
            //    m_jmargin.setText(null); // do nothing as default margin setting should stay
            } else {
    ...
    private void initComponents() {
        ...
        jGenBarCode = new javax.swing.JButton();
        ...
        add(m_jRef);
        m_jRef.setBounds(90, 50, 70, 37);
        add(m_jName);
        m_jName.setBounds(250, 50, 220, 37);
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(10, 20, 150, 20);
        jPanel1.add(m_jCode);
        m_jCode.setBounds(140, 20, 120, 20);
        jPanel1.add(m_jImage);
        m_jImage.setBounds(340, 20, 200, 170);
        ...
        m_jPriceBuy.setBounds(140, 50, 100, 20);
        ...
        jPanel1.add(m_jAtt);
        m_jAtt.setBounds(140, 210, 390, 20);

        jGenBarCode.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/gnome-tali.png"))); // NOI18N
        jGenBarCode.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/gnome-tali.png"))); // NOI18N
        jGenBarCode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jGenBarCodeActionPerformed(evt);
            }
        });
        jPanel1.add(jGenBarCode);
        jGenBarCode.setBounds(100, 10, 32, 32);
        ...
        m_jstockcost.setBounds(160, 20, 80, 37);
        ...
        m_jstockvolume.setBounds(160, 50, 80, 37);
        ...
        m_jCatalogOrder.setBounds(310, 80, 80, 37);
    ...
    private void jGenBarCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jGenBarCodeActionPerformed
        // TODO add your handling code here:
...
//        if (s_GenBarcode.equals("true")) {
        if (m_jCode.getText().isEmpty()) {
            ...
            if (mCurrentCategory != null) {
                try {
                    //m_jCode.setText(generateBarCode(m_dSales.countProductsByCategory(mCurrentCategory.getID()), mCurrentCategory.getCode()));
                    m_jCode.setText(generateBarCode(m_dSales.countProducts(),mCurrentCategory.getCode()));
                } catch (BasicException ex) {
                    Logger.getLogger(ProductsEditor.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
...
//       }
    }//GEN-LAST:event_jGenBarCodeActionPerformed

    
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jGenBarCode;
